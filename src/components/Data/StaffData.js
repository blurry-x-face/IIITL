    ...
    Administration: [
      {
        ...
        data6: {
          ...
          mobile: "",
          class: "data6 staff-column"
        },
        data7: {
          name: "Mr. Satyam Tandon",
          post: "Junior Assistant",
          email: "Email: satyam@iiitl.ac.in",
          mobile: "",
          class: "data7 staff-column"
        },
        data8: {
          name: "Ms. Monika Jain",
          post: "Junior Technician(Lib.)",
          email: "Email: monika.jain@iiitl.ac.in",
          mobile: "",
          class: "data8 staff-column"
        }
      }
    ],
    Technical: {
