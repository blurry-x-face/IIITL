    ...
    <div className="btech-global padding-res">
      <div className="btech-global-div">
        ...
        <p className="btech-p">
          ...
          Institute is made through the examination conducted by CBSE under the
          name and style of JEE (Main). Based upon the merit in the written
          examination, Central Counseling Board of JEE (Main) invites candidates
          for counseling at selected centers and seats for various participating
          institutions are allotted, based upon individual merit.
        </p>
        <p className="btech-p">
